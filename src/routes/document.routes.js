...
router.post('/upload-version', authenticate, upload.single('file'), documentController.uploadVersion);
...
router.get('/:document_id/download', authenticate, documentController.downloadOfficialVersion);
